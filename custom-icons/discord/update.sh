...
for icon in "${arr[@]}"; do
    ...
    cp /tmp/core/app/images/systemtray/linux/$icon.png $HOME/.themes/custom-icons/discord/old/$icon.png

    echo "Creating new $icon..."
    cp $HOME/.themes/custom-icons/discord/new/$icon.png /tmp/core/app/images/systemtray/linux/$icon.png
done
